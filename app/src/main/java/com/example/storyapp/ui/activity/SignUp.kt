...
//        signupViewModel = ViewModelProvider(this, RepoViewModelFactory(this))[SignupViewModel::class.java]
...
//        loginViewModel = ViewModelProvider(this, RepoViewModelFactory(this))[LoginViewModel::class.java]
    ...
    private fun isPasswordMatch() {
        if (binding.passwordInput.text.toString().trim() != binding.confirmPassInput.text.toString().trim()) {
            binding.passwordInput.error = resources.getString(R.string.pass_not_match)
